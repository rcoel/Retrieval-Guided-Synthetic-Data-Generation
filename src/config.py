...
BASE_LLM_MODEL = "Qwen/Qwen2-1.5B-Instruct" # Using a smaller model for accessibility
...
NUM_RETRIEVED_DOCS_K = 5
GENERATION_TEMP = 0.8
GENERATION_TOP_P = 0.9
MAX_NEW_TOKENS = 128 # Max length of the synthetic sample
MAX_PERPLEXITY = 50.0
